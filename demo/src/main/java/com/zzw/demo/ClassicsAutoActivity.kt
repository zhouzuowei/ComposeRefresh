 ...
 * @Description:
 */
class ClassicsAutoActivity : ComponentActivity() {
    ...
    fun getList(listFlow: Flow<SwipeUiState<String>?>) {
        ...
        SmartSwipeRefresh(
            ...
            onLoadMore = {
                loadData()
            }, headerIndicator = { MyRefreshHeader(flag = state.refreshFlag) },
            footerIndicator = { MyRefreshFooter(flag = state.loadMoreFlag)}) {
